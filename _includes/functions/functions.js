...
function SAMMICommands() {
  const SendCommand = {
    ...
    async saveIni(fileName = '', section = '', key = '', value = '', type = 'text') {
      return sendToSAMMI('SaveIni', { fileName, section, key, value, type });
    },
    ...
    async loadIni(fileName = '', section = '', key = '', type = 'text') {
      return sendToSAMMI('LoadIni', { fileName, section, key, type });
    },
    ...
    async httpRequest(url = '', method = 'GET', headers = {}, body = {}) {
      return sendToSAMMI('HttpRequest', { url, method, headers, body });
    },
